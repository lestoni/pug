 ...
 */
public class ScreenUserNotFollowingFragment extends Screen {
    private View v;
    private final static String TAG = "ScreenUserNotFollowingFragment";
    private ViewPager viewPager;
    private ListView list;
    private UserListAdapter adap;
    private FloatingActionButton fab;

    public static ScreenUserNotFollowingFragment newInstance() {
        return new ScreenUserNotFollowingFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.screen_user_not_following, container, false);
    ...
    private void testData() {
        ...
        items.add(new UserListItem(R.drawable.ic_list_item_1, getHtml("Lebron James rated on Johnsons Skill at ", ""), "5 mins ago" ));
    ...
    private Spanned getHtml(String part, String part2) {
